...
sh <br>
cd my-folder <br>
git clone https://github.com/ClaudiaRojasSoto/hello_rails_front_end.git
...
Feel free to check the [issues page](https://github.com/ClaudiaRojasSoto/hello_rails_front_end/issues).
